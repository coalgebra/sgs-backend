...
@b.array = common global [10 x i32] zeroinitializer
@b = common global i32* getelementptr inbounds ([10 x i32], [10 x i32]* @b.array, i32 0, i32 0)
...
define i32 @main() {
entry:
  %call.res = call i32 @writeGArray(i32 1, i32 2)
